// Project5.cpp: define el punto de entrada de la aplicación.
//
	...
	_In_ int       nCmdShow)
{
	...
	LoadString(hInstance, IDC_PROJECT5, szWindowClass, MAX_LOADSTRING);
	...
	hAccelTable = LoadAccelerators(hInstance, MAKEINTRESOURCE(IDC_PROJECT5));
