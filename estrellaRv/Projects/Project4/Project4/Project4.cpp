// Project4.cpp: define el punto de entrada de la aplicación.
//
	...
	_In_ int       nCmdShow)
{
	...
	LoadString(hInstance, IDC_PROJECT4, szWindowClass, MAX_LOADSTRING);
	...
	hAccelTable = LoadAccelerators(hInstance, MAKEINTRESOURCE(IDC_PROJECT4));
