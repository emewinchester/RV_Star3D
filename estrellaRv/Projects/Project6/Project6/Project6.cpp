// Project6.cpp: define el punto de entrada de la aplicación.
//
	...
	_In_ int       nCmdShow)
{
	...
	LoadString(hInstance, IDC_PROJECT6, szWindowClass, MAX_LOADSTRING);
	...
	hAccelTable = LoadAccelerators(hInstance, MAKEINTRESOURCE(IDC_PROJECT6));
...
ATOM MyRegisterClass(HINSTANCE hInstance)
{
	...
	wcex.hIcon = LoadIcon(hInstance, MAKEINTRESOURCE(IDI_PROJECT6));
