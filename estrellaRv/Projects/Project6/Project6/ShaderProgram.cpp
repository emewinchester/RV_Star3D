...
void ShaderProgram::SetUniformVec4(char * name, glm::vec4 v)
{
	GLuint location = glGetUniformLocation(program, name);
	if (location >= 0) glUniform4fv(location, 1, &v[0]);
}

void ShaderProgram::SetUniformVec3(char * name, glm::vec3 v)
{
	GLuint location = glGetUniformLocation(program, name);
	if (location >= 0) glUniform3fv(location, 1, &v[0]);
}

void ShaderProgram::SetUniformI(char * name, GLint i)
{
	GLuint location = glGetUniformLocation(program, name);
